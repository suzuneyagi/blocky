...
public class Position {
    ...
    /**
     * 
     * @param row a positive integer that indicates the block's x coordinate on the
     *            board
     * @param col a positive integer that indicates the block's y coordinate on the
     *            board
     */
     ...
     * @param col a positive integer that is to be added to the original column
     *            value
