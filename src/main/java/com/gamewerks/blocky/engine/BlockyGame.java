...
public class BlockyGame {
    ...
    private void trySpawnBlock() {
        if (activePiece == null) {
            // Here we initialize the hight by subtracting 20, so that the block spawns at
            // the top
    ...
    private void processMovement() {
        Position nextPos;
        // When we launched the game, we couldn't move, so we decided to look at this
        // method
    ...
    public void step() {
        // We saw that processMovement() was highlighting yellow, which means it wasn't
        // used
        // To allow the piece to move left and right, we added the processMovement()
        // call here.
        // It seems that step contains and calls the major functions we need to play the
        // game
        trySpawnBlock();
        processMovement();
        processGravity();
